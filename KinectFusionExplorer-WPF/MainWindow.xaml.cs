...
namespace Microsoft.Samples.Kinect.KinectFusionExplorer
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged, IDisposable
    {
        ...
        /// <summary>
        /// Author: bsterling
        /// Sends the loaded data to the SLM by invoking python code:
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>

        private void SendToSLM(object sender,RoutedEventArgs e)
        {
            //            ProcessStartInfo start = new ProcessStartInfo();
            //            start.FileName
//            var path = new Uri("pack://application:,,/scriipt.py");
...
//                MessageBox.Show(resName);
            ...
            try {
                string code = (new StreamReader(Assembly.GetExecutingAssembly().GetManifestResourceStream("Microsoft.Samples.Kinect.KinectFusionExplorer.script.py"))).ReadToEnd();
                string output = run_python_cmd("C:\\Users\\Ben\\Desktop\\KinectFusionExplorer-WPF\\script.py", "");
            }
            catch(Exception ex)
            {
        ...
        public string run_python_cmd(string cmd, string args)
        {
            ProcessStartInfo start = new ProcessStartInfo();
            start.FileName = "C:\\Users\\Ben\\AppData\\Local\\Programs\\Python\\Python37-32\\python.exe";
